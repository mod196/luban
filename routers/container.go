...
func InitContainerRouter(r *gin.RouterGroup) {
	K8sClusterRouter := r.Group("k8s")
	{
		...
		K8sClusterRouter.GET("cache/status", k8s.GetK8sCacheStatusController)
		...
		K8sClusterRouter.GET("service-tree/bindings", k8s.GetServiceTreeBindingsController)
		K8sClusterRouter.POST("service-tree/bindings", k8s.CreateServiceTreeBindingController)
		K8sClusterRouter.DELETE("service-tree/bindings", k8s.DeleteServiceTreeBindingController)
		K8sClusterRouter.GET("service-tree/unclassified", k8s.GetServiceTreeUnclassifiedController)
		K8sClusterRouter.GET("service-tree/binding-rules", k8s.GetServiceTreeBindingRulesController)
		K8sClusterRouter.POST("service-tree/binding-rules", k8s.CreateServiceTreeBindingRuleController)
		K8sClusterRouter.DELETE("service-tree/binding-rules", k8s.DeleteServiceTreeBindingRuleController)
		K8sClusterRouter.GET("service-tree/policies", k8s.GetServiceTreePoliciesController)
		K8sClusterRouter.POST("service-tree/policies", k8s.CreateServiceTreePolicyController)
		K8sClusterRouter.DELETE("service-tree/policies", k8s.DeleteServiceTreePolicyController)
		K8sClusterRouter.GET("service-tree/authorized-resources", k8s.GetServiceTreeAuthorizedResourcesController)
		K8sClusterRouter.GET("service-tree/principals", k8s.GetServiceTreePrincipalsController)
		K8sClusterRouter.GET("service-tree/app-labels", k8s.GetServiceTreeAppLabelsController)
