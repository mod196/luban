...
export const GetK8sServiceTreeBindings = (clusterId, params) => get('/api/v1/k8s/service-tree/bindings?clusterId=' + clusterId, params)
export const BindK8sServiceTreeResource = (params) => post('/api/v1/k8s/service-tree/bindings', params)
export const DeleteK8sServiceTreeBinding = (params) => del('/api/v1/k8s/service-tree/bindings', params)
export const GetK8sServiceTreeUnclassified = (clusterId) => get('/api/v1/k8s/service-tree/unclassified?clusterId=' + clusterId)
export const GetK8sServiceTreeBindingRules = (clusterId, params) => get('/api/v1/k8s/service-tree/binding-rules?clusterId=' + clusterId, params)
export const CreateK8sServiceTreeBindingRule = (params) => post('/api/v1/k8s/service-tree/binding-rules', params)
export const DeleteK8sServiceTreeBindingRule = (params) => del('/api/v1/k8s/service-tree/binding-rules', params)
export const GetK8sServiceTreePolicies = () => get('/api/v1/k8s/service-tree/policies')
export const CreateK8sServiceTreePolicy = (params) => post('/api/v1/k8s/service-tree/policies', params)
export const DeleteK8sServiceTreePolicy = (params) => del('/api/v1/k8s/service-tree/policies', params)
export const GetK8sServiceTreeAuthorizedResources = (params) => get('/api/v1/k8s/service-tree/authorized-resources', params)
export const GetK8sServiceTreePrincipals = (params) => get('/api/v1/k8s/service-tree/principals', params)
export const GetK8sServiceTreeAppLabels = (clusterId, params) => get('/api/v1/k8s/service-tree/app-labels?clusterId=' + clusterId, params)
